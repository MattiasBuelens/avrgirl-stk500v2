...
test('[ AVRGIRL-STK500V2 ] ::getSignature', function (t) {
  var a = new avrgirl(FLoptions);
  var spyw = sinon.spy(a, '_writeAsync');
  var spyr = sinon.spy(a, '_readAsync');
...
test('[ AVRGIRL-STK500V2 ] ::loadAddress', function (t) {
  var a = new avrgirl(FLoptions);
  var spy = sinon.spy(a, '_sendCmdAsync');
  var dMSB1 = 0x80;
  var dMSB2 = 0x00;
...
test('[ AVRGIRL-STK500V2 ] ::writeFlash', function (t) {
  var a = new avrgirl(FLoptions);
  var spy = sinon.spy(a, '_writeMemAsync');
...
test('[ AVRGIRL-STK500V2 ] ::readEeprom', function (t) {
  var a = new avrgirl(FLoptions);
  var spy = sinon.spy(a, '_readMemAsync');
  var length = 20;
...
test('[ AVRGIRL-STK500V2 ] ::quickFlash', function (t) {
  var a = new avrgirl(FLoptions);
  var spyEnter = sinon.spy(a, '_enterProgrammingModeAsync');
  var spyw = sinon.spy(a, '_writeFlashAsync');
  var spyExit = sinon.spy(a, '_exitProgrammingModeAsync');
  var file = __dirname + '/data/pr.hex';
...
test('[ AVRGIRL-STK500V2 ] ::quickEeprom', function (t) {
  var a = new avrgirl(FLoptions);
  var spyEnter = sinon.spy(a, '_enterProgrammingModeAsync');
  var spyw = sinon.spy(a, '_writeEepromAsync');
  var spyExit = sinon.spy(a, '_exitProgrammingModeAsync');
  var file = __dirname + '/data/eeprom.hex';
